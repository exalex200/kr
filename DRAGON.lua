...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/HeA0/test/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/HeA0/test/main/DRAGON.lua')
...
if Debn(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/HeA0/test/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/HeA0/test/main/File_Bot/"..file)
if res == 200 then
