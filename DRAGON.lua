...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/exalex200/kr/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/exalex200/kr/main/DRAGON.lua')
...
if Debn(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/exalex200/kr/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/exalex200/kr/main/File_Bot/"..file)
if res == 200 then
